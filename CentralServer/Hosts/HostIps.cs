        ...
        public static readonly Host[] hosts = new Host[]
            {
                ...
                new Host(HostNames.STUDENT_INTERFACE, "192.168.1.21", "Student UI web interface"),
                ...
                new Host(HostNames.FORENSICS_MACHINE_3, "192.168.1.x", "Forensics student machine 3"),
